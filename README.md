...
Additionally, there is a [helper file](code/index_helper.py) that can be used to show the indices for the CSV fields. However, remember that you need to use the `AdjustedIndex` field for the index values in the Index file you create!
